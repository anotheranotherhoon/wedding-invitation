...
const Home = (props : IData) => {
  ...
  return (
    <Layout>
      ...
      <SpecificInfo date={props.weddingDate} time={props.time} address={props.address} bus={props.bus} subway={props.subway} parking={props.parkingLot} place={props.place} hall_name={props.hall_name} brid_name={props.client.brid.name} groom_name={props.client.groom.name} lat={props.lat} lng={props.lng}/>
      <AccountNumber
